...
<body id="item1">
	<div id="wrapper">
		...
		<div id="content">
			...
			$pdf->Text(155, 35, 'Folio: SMT-VHSA-RH-131/13');
			...
			$pdf->Text(55, 54, utf8_decode('Av. Sandino Frente a Clínica CERACOM'));
			...
			*/
			...
			$pdf->Text(155, 170, 'Folio: SMT-VHSA-RH-131/13');
			...
			$pdf->Text(55, 189, utf8_decode('Av. Sandino Frente a Clínica CERACOM'));

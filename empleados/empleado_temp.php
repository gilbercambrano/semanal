		...
		<?php
								if(isset($_GET['id_empleado']) && $_GET['id_empleado']!=''){
									if ($empleado->loadById($_GET['id_empleado'])){
										...
										$periodo->loadById($empleado_puesto->getPeriodo());
										$empleado_puesto->loadByEmpleado($empleado->getId());
										...
										$tipo_sangre=$empleado->getTipoSangre();
										$telefono_fijo=$empleado->getTelefonoFijo();
										$telefono_movil=$empleado->getTelefonoMovil();
										$curp = $empleado->getCurp();
										$ife = $empleado->getIfe();
										$matricula_smn = $empleado->getMatriculaSmn();
										$licencia = $empleado->getLicencia();
										$email = $empleado->getEmail();
										$fecha_inicio = $empleado->getFechaInicio();
										$observaciones=$empleado->getObservaciones();
										$id_detalle_direccion = $empleado->getDetalleDireccion();
										$id_clinica = $empleado->getClinica();
										$id_cuenta_bancaria = $empleado->getCuentaBancaria();
										$numero_cuenta = $cuenta_bancaria->getNumeroCuenta();
										$id_compania_empleado=$compania_empleado->getId();

										$calle = $detalle_direccion->getCalle();
										$numero_exterior = $detalle_direccion->getNumeroExterior() ;
										$numero_interior = $detalle_direccion->getNumeroInterior() ;

										$id_localidad = $localidad->getId();
										$m = $localidad->getM();
										$nombre_localidad = $localidad->getNombre();
										$id_estado = $estado->getId();

										$nombre_estado = $estado->getNombre();
										$nombre_municipio = $municipio->getNombre();
										$clave_estado = $estado->getClave();
									//	$clave_localidad = $localidad->getClave();
										




										$id_empleado_puesto = $empleado_puesto->getId();
										$salario = $empleado_puesto->getSalario();

										$id_periodo = $periodo->getId();
										$nombre_periodo = $periodo->getNombre();

										$nombre_completo_empleado = $empleado->getNombre() . ' ' . $empleado->getApellidoPaterno() . ' ' . $empleado->getApellidoMaterno();
										...
										$fecha_inicio  = '';
										$observaciones = '';
										$id_detalle_direccion  = '';
										$id_clinica  = '';
										$id_cuenta_bancaria  = '';
										$numero_cuenta = '';
										$id_compania_empleado='';
		...
		<div id="content">
				...
				<div class="inner">
					...
					<div class="tittle">
						...
						<form class="formulario" method="GET">
							...
							<input type="hidden" name="id_compania_empleado" value="<?php echo $id_compania_empleado; ?>" >
							...
							<fieldset> 
								...
								<table class="tab_form">
									<tr>
										...
										<td>
											<input type="text" name="nombre" required class="box" value="<?php echo $nombre ; ?>" >
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" name="apellido_paterno" required class="box" value="<?php echo $apellido_paterno; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" name="apellido_materno" class="box"  value="<?php echo $apellido_materno; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<select name="sexo" class="drop2">
												<option value="MASCULINO" <?php if($sexo=='MASCULINO') echo "selected='selected'"; ?> class="opdrop2">Masculino</option>
												<option value="FEMENINO" <?php if($sexo=='FEMENINO') echo "selected='selected'"; ?> class="opdrop2">Femenino</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" id="fecha_nacimiento" name="fecha_nacimiento" class="box" value="<?php echo $fecha_nacimiento; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											...
											<input type="text" name="tipo_sangre" class="box" value="<?php echo $tipo_sangre; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											...
											<input type="text" name="telefono_fijo" class="box" value="<?php echo $telefono_fijo; ?>">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="telefono_movil" class="box" value="<?php echo $telefono_movil; ?>" >
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="ife" class="box" value="<?php echo $ife ; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" required maxlength="18" name="curp" class="box" value="<?php echo $curp; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" name="licencia" class="box" value="<?php echo $licencia; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" name="matricula_smn" class="box" value="<?php echo $matricula_smn; ?>">
										</td>
									</tr>
								</table>
							</fieldset>
							...
							<fieldset> 
								...
								<table class="tab_form">
														...
														<option value=<?php echo $value['id_estado']; ?> 
															<?php 
																if(isset($_GET['id_empleado'])){
																	if($value['clave'] == $id_estado) echo "selected=\"selected\"";
																}
																else{
													...
													foreach($municipios as $value){
														...
														if($value['id_estado']==27){
															...
															<option value=<?php echo $value['id_municipio']; ?>  
																...
																<?php if($value['id_municipio'] == $m ) echo "selected='selected'" ?>
									...
									<tr>
										<td class="lab">
											Colonia:
											<input type="hidden" id="id_localidad" name="id_localidad" value="<?php echo $id_localidad; ?>" >
									</td>
										<td>
											<input type="text" name="localidad" id="localidad" class="box" value="<?php echo $nombre_localidad; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" name="calle" class="box" value="<?php echo $calle ; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" name="numero_exterior" class="box" value="<?php echo $numero_exterior; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
										...
										<td>
											<input type="text" name="numero_interior" class="box" value="<?php echo $numero_interior; ?>">
										</td>
									</tr>
								</table>
							</fieldset>   
							...
							<fieldset> 
								...
								<table class="tab_form">
									...
									<tr>
										...
										<td>
											<input type="text" name="fecha_inicio" required class="box"  id="fecha_inicio" value="<?php echo $fecha_inicio; ?>">
										</td>
									</tr>
									<tr>
										<td class="lab">
								...
								<!--	<tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="numero_cuenta" class="box" value="<?php echo $numero_cuenta; ?>">
											<?php
												if(isset($_GET['id_empleado'])) {
							...
							<fieldset>
								...
								<table class="tab_form">
									<tr>
										...
										<td>
											<textarea name="observaciones" class="boxarea"><?php echo'';?> </textarea>
			...
			<?php
				if(isset($_GET['accion']) && $_GET['accion'] == 'insertar'){
					...
					?>
						<script type="text/javascript">
							...
							window.location = "empleado_temp.php";
						</script>
					<?php
				...
				*/
					...
					window.location = "empleado_temp.php?accion=update&id_empleado="+ <?php echo $_GET['id_empleado']; ?>;
					</script> 	
					<?php
